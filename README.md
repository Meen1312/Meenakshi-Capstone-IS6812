...
####  Difficulties Encountered
  - Class Imbalance: The dataset was heavily skewed (91% non-defaults, 9% defaults), which made it challenging to achieve high recall for the minority class. Addressed this using oversampling, undersampling, and class weighting.
